...
with open("C:\\Users\\하앙재워니\\Desktop\\test_result.txt", "w")as txt:
    for test_num in range(100):
        ...
        while True:
            ...
            # if there is no remaining calls
            if not update_evaluation_factor() and count > 40:
                txt.write(str(round(wtime, 3)))
                txt.write("\n")
                break
